...
def execution_sources():
    ...
    paths += [ROOT/p for p in ['experiments/dual_reference/public_data.py',
        'experiments/xy/run.py','experiments/real_era5/run_experiment.py',
...
def main(name,reference_kind="centroid",output_root=OUT):
    ...
    methods=[('TMTM','TMTM',None),('ST-MTM','ST-MTM',None),
             ('X-only RA-MTM','X-only RA-MTM',None),('Dual-Reference RA-MTM','X-only RA-MTM','Dual-Y')]
